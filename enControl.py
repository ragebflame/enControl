    ...
    "switch": [
        {
            "id": u"1",
            "command": [
                {"on": [True, True, True, True], "off": [True, True, True, False]}
            ],
        },
        {
            "id": u"2",
            "command": [
                {"on": [False, True, True, True], "off": [False, True, True, False]}
            ],
        },
        {
            "id": u"3",
            "command": [
                {"on": [True, False, True, True], "off": [True, False, True, False]}
            ],
        },
        {
            "id": u"4",
            "command": [
                {"on": [False, False, True, True], "off": [False, False, True, False]}
            ],
        },
        {
            "id": u"all",
            "command": [
                {"on": [True, True, False, True], "off": [True, True, False, False]}
            ],
        },
    ]
}
...
def post_command():
    ...
    if not request.json or "id" not in request.json or "command" not in request.json:
        abort(400)
